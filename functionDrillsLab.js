...
console.log(exclaimThree('Justin'))
...
let colorsArr = ['red', 'black', 'blue', 'green']
/*
...
//CODE HERE
const printAllNames = namesArray => {
  for(let i = 0; i < namesArray.length; i++){
    console.log(namesArray[i])
  }
}
printAllNames(colorsArr)
...
let movieTitle = bestMovie('Titanic')
...
const theEliminator = (con, loserVar) => {
  for (let i = 0; i < con.length; i++) {
    if (con[i].toLowerCase() === loserVar.toLowerCase()) {
      con.splice(i, 1)
    }
  }
  return con
...
let totalFrogs2 = frogBuy2(7)
console.log(totalFrogs2)


////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0,0,0,3,4,6,6,8,7,9]
/*
